...
@Component
public class LoginByVerificationCodeFilter extends LoginFilter {
    @Override
    public void setAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain, LoginUser loginUser) throws IOException, ServletException {
        PhoneNumberAuthenticationToken authenticationToken = new PhoneNumberAuthenticationToken(loginUser, null, UserUtil.getAuthoritiesByUserRole(loginUser.getRole()));
